  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/layoutAdmin">
        ...
        <div class="sidebar-brand-text mx-3 text-dark">SCI</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/productos/add">Agregar productos</a>
            <a class="collapse-item"  href="/productos/list">Todos los Productos</a>
          </div>
        </div>
      </li>
